...
<a href="https://completed-frontend-mentor-challenges.vercel.app/coding-bootcamp-testimonials-slider" target="_blank" rel="noopener noreferrer" title="Live Demo" style="display: block; font-weight: bold; text-transform: uppercase; text-decoration: underline; font-size: 1.3rem; margin: 1rem; margin-left: 25%;">
  Live Demo 
...
In this challenge, I developed a testimonial slider using HTML, CSS, and JavaScript. I learned how to create dynamic HTML components and handle events with JavaScript
